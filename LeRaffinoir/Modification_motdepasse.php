...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // TODO: Ajoutez des validations supplémentaires selon vos besoins
    ...
    if (password_verify($ancienMotDePasse, $_SESSION['hashed_password'])) {
        ...
        if ($nouveauMotDePasse === $confirmerNouveauMotDePasse) {
            ...
            require 'BD_Connection.php'; // Assurez-vous d'inclure correctement le fichier de connexion à la base de données
